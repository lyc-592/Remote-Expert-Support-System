...
#include <memory>
#include "../Remote-Expert-Support-System/ui/index/factory/homepage.h"
...
QT_MOC_LITERAL(1, 9, 10), // "gotoAgenda"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "gotoDevice"
QT_MOC_LITERAL(4, 32, 11) // "gotoHistory"

    },
    "HomePage\0gotoAgenda\0\0gotoDevice\0"
    "gotoHistory"
};
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gotoAgenda(); break;
        case 1: _t->gotoDevice(); break;
        case 2: _t->gotoHistory(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomePage::gotoAgenda)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HomePage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomePage::gotoDevice)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (HomePage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomePage::gotoHistory)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void HomePage::gotoAgenda()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HomePage::gotoDevice()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void HomePage::gotoHistory()
{
