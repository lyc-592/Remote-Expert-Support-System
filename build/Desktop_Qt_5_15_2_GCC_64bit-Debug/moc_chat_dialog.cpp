...
QT_MOC_LITERAL(1, 11, 17), // "sendMessageSignal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "contactId"
QT_MOC_LITERAL(4, 40, 7), // "message"
QT_MOC_LITERAL(5, 48, 13) // "onSendClicked"

    },
    "ChatDialog\0sendMessageSignal\0\0contactId\0"
    "message\0onSendClicked"
};
...
void ChatDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMessageSignal((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ChatDialog::*)(const int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatDialog::sendMessageSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatDialog::sendMessageSignal(const int _t1, const QString & _t2)
{
