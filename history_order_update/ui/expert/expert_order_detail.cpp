...
ExpertOrderDetail::ExpertOrderDetail(int orderId, DatabaseManager* dbManager, QWidget *parent)
...
void ExpertOrderDetail::setupUI()
{
    ...
    formLayout->addRow("工厂:", factoryLabel);
    ...
    connect(closeButton, &QPushButton::clicked, this, &ExpertOrderDetail::accept);
    buttonLayout->addWidget(closeButton);

    mainLayout->addLayout(buttonLayout);
}

void ExpertOrderDetail::loadOrderDetails()
{
    ...
    factoryLabel->setText(query.value("factory_info").toString());
