...
struct Device {
    ...
    // 带参数的构造函数
    Device(int deviceId, const QString& deviceName, const QString& deviceType, const QString& status)
        : deviceId(deviceId), deviceName(deviceName), deviceType(deviceType), status(status)
    {}
