...
private:
    ...
    void processRemoveDevice(QTcpSocket *clientSocket, const QJsonObject &request);


    void sendResponse(QTcpSocket *clientSocket, const QJsonObject &response);

    void processSendChatMessage(QTcpSocket *clientSocket, const QJsonObject &request);
    void processGetChatHistory(QTcpSocket *clientSocket, const QJsonObject &request);

    void processAddSimulateData(QTcpSocket *clientSocket, const QJsonObject &request);
    void processGetNonContactUsers(QTcpSocket *clientSocket, const QJsonObject &request);
    void processAddContact(QTcpSocket *clientSocket, const QJsonObject &request);
    void processGetAllDevicesRequest(QTcpSocket *clientSocket, const QJsonObject &request);

    void processUpdateDevice(QTcpSocket *clientSocket, const QJsonObject &request);
    void broadcastMessage(const QJsonObject &message, QTcpSocket *excludeSocket);
